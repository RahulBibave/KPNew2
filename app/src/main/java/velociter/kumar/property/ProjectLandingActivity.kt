                        ...
                        if ( mProjectData.get(0).mPriceArea.get(i).mPriceFrom.equals("00")){
                            ...
                            if (n < 10000000) {
                                ...
                                try{
                                    ...
                                    z=z+mProjectData.get(0).mPriceArea.get(i).mFlatType+" - "+y.toString().substring(0,4)+" Lac(s) " +mProjectData.get(0).mPriceArea.get(i).mPriceSuffix+"\n"
                                ...
                                val y = n / 100000 * 0.01
                                try {
                                    z=z+mProjectData.get(0).mPriceArea.get(i).mFlatType+" - "+y.toString()+" Cr " +mProjectData.get(0).mPriceArea.get(i).mPriceSuffix+"\n"
